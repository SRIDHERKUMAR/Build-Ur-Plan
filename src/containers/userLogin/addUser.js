...
import {addNewUser} from "../../redux/actions/login_actions";
...
class AddUser extends React.Component {
    ...
    async addNewUser() {
        if(!this.state.userExists) {
            const addUserUrl = `https://apiserverdata.com/users/addUser`;
            try {
                ...
                await this.props.canAddUser(false)
            } catch (e) {
...
const mapDispatchToProps = dispatch => ({
    canAddUser: (data) => dispatch(addNewUser(data))
});
